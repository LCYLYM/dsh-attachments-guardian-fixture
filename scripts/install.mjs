...
const PACKAGE_NAME = 'dsh-multimedia-webui-input';
...
async function installLegacy() {
  ...
  const packageTarget = join(resolverRoot, 'dsh-multimedia-webui-input');
...
async function uninstallLegacy() {
  ...
  const expectedPackageTarget = join(resolve(metadata.resolverRoot), 'dsh-multimedia-webui-input');
